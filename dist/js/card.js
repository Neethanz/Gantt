...
Nova.booting(function (Vue, router) {
    Vue.component('Gantt', __webpack_require__(127));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        drawChart: function drawChart() {
            ...
            var columnKeys = Object.keys(this.card.columns);
            var columnValues = Object.values(this.card.columns);
            columnKeys.forEach(function (c, i) {
                data.addColumn(columnValues[i], c);
            });

            data.addRows(this.card.rows.map(function (item) {
                return item.map(function (value, i) {
                    if (i === 0) {
                        i = i.toString();
                    }
                    ...
                    if (columnValues[i] === 'date') {
                        console.log(value);
                        value = __WEBPACK_IMPORTED_MODULE_0_moment___default()(value).toDate();
                        //console.log(value);
                    }
                    return value;
                });
